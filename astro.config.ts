...
const indexableSitemapUrls = new Set([
  ...
  'https://solutions.futurion.es/healthcare-ai-privacy-guardrails-presidio-openai-privacy-filter/',
  ...
  'https://solutions.futurion.es/es/es-barreras-control-privacidad-ia-sanitaria-presidio-openai-privacy-filter/',
...
export default defineConfig({
  ...
  redirects: {
    ...
    '/es/automatizacion-responsable': '/es/es-automatizacion-responsable/',
    '/es-barreras-control-privacidad-ia-sanitaria-presidio-openai-privacy-filter': '/es/es-barreras-control-privacidad-ia-sanitaria-presidio-openai-privacy-filter/',
    '/es/barreras-control-privacidad-ia-sanitaria-presidio-openai-privacy-filter': '/es/es-barreras-control-privacidad-ia-sanitaria-presidio-openai-privacy-filter/',
