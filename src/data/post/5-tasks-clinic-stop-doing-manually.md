...
lang: en
metadata:
  title: '5 Clinic Tasks to Automate Now | Healthcare Workflow Guide'
  description: 'Independent clinics lose hours every week to manual admin tasks. Discover the 5 highest-impact workflows to automate — patient registration, appointments, insurance claims, inventory, and follow-ups.'
  robots:
    index: true
    follow: true
  openGraph:
