...
metadata:
  ...
  description: '5 highest-impact admin workflows to automate in independent clinics: patient registration, appointments, insurance claims, inventory, and follow-ups.'
  robots:
    index: true
    follow: true
  openGraph:
