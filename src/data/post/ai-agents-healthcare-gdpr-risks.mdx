...
metadata:
  title: 'AI Agents & Healthcare GDPR Risks'
...
> - The EU AI Act lists specific healthcare uses as high-risk under Annex III; after the June 2026 Digital Omnibus those obligations apply from December 2027 — but the GDPR exposure described here exists today and does not wait for the AI Act timeline.
...
Yes, in virtually all cases. GDPR Article 35 requires a Data Protection Impact Assessment when processing is likely to result in high risk to individuals. AI agents that access health records, process special category data, or make or support automated decisions affecting patients meet this threshold. The DPIA must be completed before the agent is deployed, not after. The Spanish Data Protection Agency (AEPD) enforces across healthcare organisations of all sizes: in 2025 it concluded 34 sanction or warning procedures in the health sector — up 278% year on year — and breach-related procedures rose 157% nationwide ([AEPD 2025 annual report](https://www.aepd.es/prensa-y-comunicacion/notas-de-prensa/la-agencia-recibio-mas-de-30.000-reclamaciones-en-2025-un-64-mas)). What decides those procedures is documentation — which is exactly what a [completed DPIA](/data-protection-impact-assessment-healthcare-ai/) provides.
...
The EU AI Act lists certain healthcare uses as high-risk under Annex III — for example AI used in emergency triage or to evaluate access to essential services — and covers AI embedded in regulated medical devices via Annex I. Under the Digital Omnibus adopted in June 2026, high-risk obligations apply from 2 December 2027 for Annex III systems and 2 August 2028 for Annex I. Most of those duties — conformity assessment, registration in the EU database, risk management, technical documentation — fall on the provider of the system; deployers such as clinics have narrower duties, mainly human oversight, using the system as instructed, and monitoring its operation. None of this changes GDPR: a practice deploying AI agents today must already satisfy Articles 9, 22 and 35. Assess against both frameworks, but do not wait for 2027 — the GDPR obligations are current.
