...
metadata:
  ...
  description: 'A practical starting point for enterprise AI governance — principles, ownership, the NIST AI RMF, lifecycle controls, and training. Governance as a competitive advantage, not a brake.'
  robots:
    index: true
    follow: true
  openGraph:
