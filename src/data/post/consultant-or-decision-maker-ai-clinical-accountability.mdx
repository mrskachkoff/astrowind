...
metadata:
  title: "AI Role and Clinical Accountability"
  description: "How AI's role — advisory vs. decisional — affects clinical accountability and GDPR compliance. Research-backed analysis for healthcare practices."
  robots:
    index: true
    follow: true
  openGraph:
