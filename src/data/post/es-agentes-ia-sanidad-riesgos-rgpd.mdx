...
metadata:
  title: 'Agentes IA y RGPD en Sanidad: Riesgos'
  description: 'El Índice MIT 2025 detectó controles débiles en agentes IA. Riesgos RGPD reales para consultas sanitarias y cómo desplegar IA con cumplimiento.'
  robots:
    index: true
    follow: true
  openGraph:
...
> - La Ley de IA de la UE recoge usos sanitarios concretos como de alto riesgo bajo el Anexo III; tras el Ómnibus Digital de junio de 2026, esas obligaciones se aplican desde diciembre de 2027 — pero la exposición al RGPD descrita aquí existe hoy y no espera al calendario de la Ley de IA.
...
Sí, en prácticamente todos los casos. El Artículo 35 del RGPD exige una Evaluación de Impacto sobre la Protección de Datos cuando el tratamiento pueda entrañar un alto riesgo para las personas. Los agentes de IA que acceden a historiales sanitarios, tratan datos de categoría especial o toman o apoyan decisiones automatizadas que afectan a pacientes alcanzan este umbral. La EIPD debe completarse antes de que se despliegue el agente, no después. La Agencia Española de Protección de Datos (AEPD) actúa en organizaciones sanitarias de todos los tamaños: en 2025 concluyó 34 procedimientos sancionadores o de apercibimiento en el sector sanitario —un 278 % más que el año anterior— y los procedimientos relacionados con brechas de seguridad aumentaron un 157 % en todo el país ([informe anual de la AEPD de 2025](https://www.aepd.es/prensa-y-comunicacion/notas-de-prensa/la-agencia-recibio-mas-de-30.000-reclamaciones-en-2025-un-64-mas)). Lo que decide esos procedimientos es la documentación, que es exactamente lo que aporta [una EIPD completada](/es/es-eipd-evaluacion-impacto-proteccion-datos-ia-sanitaria/).
...
La Ley de IA de la UE recoge determinados usos sanitarios como de alto riesgo bajo el Anexo III — por ejemplo, la IA utilizada en triaje de urgencias o para evaluar el acceso a servicios esenciales — y cubre la IA integrada en productos sanitarios regulados a través del Anexo I. Con el Ómnibus Digital adoptado en junio de 2026, las obligaciones de alto riesgo se aplican desde el 2 de diciembre de 2027 para los sistemas del Anexo III y desde el 2 de agosto de 2028 para los del Anexo I. La mayoría de esos deberes — evaluación de conformidad, registro en la base de datos de la UE, gestión de riesgos, documentación técnica — recaen sobre el proveedor del sistema; los responsables del despliegue, como las consultas, tienen obligaciones más limitadas, centradas en la supervisión humana, el uso conforme a las instrucciones y la vigilancia de su funcionamiento. Nada de esto cambia el RGPD: una consulta que despliega agentes de IA hoy ya debe cumplir los Artículos 9, 22 y 35. Evalúa frente a ambos marcos, pero no esperes a 2027 — las obligaciones del RGPD son vigentes ya.
