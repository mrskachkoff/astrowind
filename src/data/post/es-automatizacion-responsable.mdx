...
metadata:
  title: 'Automatización Responsable en Sanidad'
  description: 'La automatización sanitaria responsable exige privacidad, permisos por rol, auditabilidad, interoperabilidad y responsabilidad humana en la arquitectura.'
  robots:
    index: true
    follow: true
  openGraph:
