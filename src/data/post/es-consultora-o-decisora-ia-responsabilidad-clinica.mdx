...
metadata:
  title: "IA Sanitaria: ¿Consultora o Decisora?"
  description: "Cómo el rol de la IA —consultiva vs. decisional— afecta la responsabilidad clínica y el RGPD. Análisis con evidencia empírica para consultas sanitarias."
  robots:
    index: true
    follow: true
  openGraph:
