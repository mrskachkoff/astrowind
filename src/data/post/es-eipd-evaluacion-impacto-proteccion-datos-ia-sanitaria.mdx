...
metadata:
  title: "Evaluación de Impacto en IA Sanitaria"
  description: "Guía práctica de EIPD para organizaciones sanitarias con IA: activadores legales, siete pasos y escenarios clínicos mapeados al Artículo 35 del RGPD."
  robots:
    index: true
    follow: true
  openGraph:
...
## Cómo es en la práctica la aplicación de la norma en España

Conviene situar la obligación de realizar una EIPD en lo que hace realmente la autoridad de control española. En 2025 la AEPD recibió 30.931 reclamaciones —una cifra récord, un 64 % más que el año anterior— y concluyó 34 procedimientos sancionadores o de apercibimiento en el sector sanitario, un 278 % más que en 2024. El mayor crecimiento se produjo en la gestión de brechas de seguridad: los procedimientos vinculados a brechas de seguridad aumentaron un 157 %, pasando de 30 en 2024 a 77 en 2025, y generaron 19,8 millones de euros en sanciones —aproximadamente el 40 % de todo lo impuesto por la AEPD ese año— ([nota de prensa del informe anual de la AEPD de 2025](https://www.aepd.es/prensa-y-comunicacion/notas-de-prensa/la-agencia-recibio-mas-de-30.000-reclamaciones-en-2025-un-64-mas)).

Dos casos ya resueltos muestran cómo esto afecta a clínicas ordinarias y no solo a grandes grupos hospitalarios. Una clínica dental de Barcelona fue sancionada con 30.000 euros: 20.000 euros en virtud del Artículo 5(1)(c) por exigir una copia del DNI de un paciente para tramitar una devolución que podría haber completado con los datos que ya tenía, más 10.000 euros en virtud del Artículo 38 por no trasladar la reclamación a su propio delegado de protección de datos ([Economist & Jurist](https://www.economistjurist.es/actualidad-juridica/jurisprudencia/sancionan-con-30-000-euros-a-una-clinica-dental-por-pedir-una-copia-del-dni-para-una-devolucion-economica/)). Otra clínica dental pagó 20.000 euros tras un ataque de ransomware que entró a través de un puerto de escritorio remoto abierto: 15.000 euros por no contar con medidas de seguridad adecuadas y 5.000 euros por notificar a la AEPD 22 días después del ataque —el plazo del RGPD es de 72 horas— ([resumen del caso](https://www.lksnext.com/es/noticias_boletin/sancion-de-20-000-euros-a-una-clinica-dental-como-consecuencia-de-la-encriptacion-de-los-datos-de-sus-pacientes/)).

Hay dos cosas que conviene interpretar correctamente en estas cifras. La actuación sancionadora contra proveedores sanitarios se activa por reclamación y, en términos absolutos, sigue siendo poco frecuente —34 procedimientos al año en todo el país no son una oleada de inspecciones—. Pero cuando se abre un procedimiento, lo que decide el resultado es la documentación: si la organización puede demostrar que evaluó los riesgos, eligió medidas proporcionadas e implicó a las personas adecuadas antes del incidente. Eso es precisamente lo que aporta una EIPD como evidencia. La clínica sancionada por sus medidas de seguridad reactivas fue, en esencia, sancionada por no tener constancia de haber pensado en el riesgo con antelación.
