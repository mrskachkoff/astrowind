...
metadata:
  title: 'IA Híbrida en Sanidad: Enfoque RGPD'
  description: 'Cómo AWS European Sovereign Cloud y GPU local permiten IA híbrida conforme al RGPD para sanidad. Mapa de riesgos, requisitos de EIPD y análisis de costes.'
  robots:
    index: true
    follow: true
  openGraph:
