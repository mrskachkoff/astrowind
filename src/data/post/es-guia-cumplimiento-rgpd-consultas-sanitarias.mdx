...
metadata:
  title: 'RGPD para Consultas Sanitarias: Guía'
  description: 'Guía completa de cumplimiento RGPD para consultas sanitarias independientes. Protege datos de pacientes y evita sanciones sin equipo de cumplimiento.'
---
