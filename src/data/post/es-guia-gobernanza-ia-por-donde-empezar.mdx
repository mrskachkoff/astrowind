...
metadata:
  ...
  description: 'Un punto de partida práctico para la gobernanza de IA empresarial: principios, responsabilidad, el NIST AI RMF, controles del ciclo de vida y formación.'
  robots:
    index: true
    follow: true
  openGraph:
