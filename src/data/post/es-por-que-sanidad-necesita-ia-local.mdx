...
metadata:
  title: 'Por Qué la Sanidad Necesita IA Local'
  description: 'Por qué la IA local es el único enfoque defendible para consultas sanitarias. Los contratos de nube no son soberanía de datos: el caso por la IA en local.'
---
...
La Ley de IA de la UE entró en vigor en agosto de 2024, y su calendario se revisó con el Ómnibus Digital adoptado en junio de 2026: las obligaciones para los sistemas autónomos de alto riesgo (Anexo III) se aplican ahora desde el 2 de diciembre de 2027, y para la IA integrada en productos sanitarios regulados (Anexo I) desde el 2 de agosto de 2028. No todos los sistemas de IA sanitaria son de alto riesgo — la clasificación cubre usos concretos como el apoyo a la decisión clínica y el triaje de urgencias, y la mayoría de las obligaciones recaen sobre el proveedor del sistema y no sobre la consulta que lo despliega. Cuando un sistema es de alto riesgo, los requisitos incluyen:
...
El aplazamiento no cambia nada del panorama del RGPD: las obligaciones sobre datos de salud — Artículos 9, 25 y 35 — se aplican en su totalidad hoy, sea cual sea la arquitectura que elijas.
