...
metadata:
  title: "OpenEvidence UE: Caso para IA Privada"
  description: "Por qué la retirada de OpenEvidence de la UE apunta a IA sanitaria on-premise y nube soberana — análisis de RGPD, Reglamento de IA y subencargados."
  robots:
    index: true
    follow: true
  openGraph:
...
<p className="text-center text-sm font-medium">En abril de 2026, en la UE:</p>
...
Y si los datos se transfieren fuera de la UE, el capítulo V del RGPD exige un mecanismo de transferencia válido, como el DPF para empresas estadounidenses certificadas o cláusulas contractuales tipo con garantías adecuadas. (El propio DPF superó el recurso de anulación Latombe ante el Tribunal General de la UE en septiembre de 2025, aunque hay un recurso pendiente ante el Tribunal de Justicia —se mantiene vigente en la actualidad, pero es un mecanismo que conviene vigilar—.)

Ahora añadamos el Reglamento de IA.

Si un sistema de IA médica apoya flujos de trabajo clínicos, diagnóstico, tratamiento o funciones reguladas de producto sanitario, puede activar obligaciones de alto riesgo relacionadas con documentación, supervisión, monitorización y gestión del riesgo — aplicables desde diciembre de 2027 para los sistemas autónomos del Anexo III y desde agosto de 2028 para la IA integrada en productos sanitarios, tras el aplazamiento del Ómnibus Digital de junio de 2026.
...
<p className="text-center text-sm font-medium">Posible infraestructura.</p>
