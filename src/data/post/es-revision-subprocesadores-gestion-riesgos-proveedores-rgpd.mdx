...
metadata:
  title: 'Subprocesadores RGPD en Sanidad | Guía'
  description: 'Gestión de subencargados RGPD en sanidad: cláusulas de transferencia, decisiones de adecuación, verificación del Marco de Privacidad y gestión de riesgos.'
  robots:
    index: true
    follow: true
  openGraph:
...
La base jurídica del DPF fue puesta a prueba y, por el momento, confirmada: el 3 de septiembre de 2025 el Tribunal General de la UE desestimó el recurso Latombe (T-553/23), que pretendía anular la decisión de adecuación, confirmando tanto la independencia del Tribunal de Revisión de Protección de Datos de EE.UU. como las garantías en torno a la recopilación de inteligencia ([IAPP](https://iapp.org/news/a/european-general-court-dismisses-latombe-challenge-upholds-eu-us-data-privacy-framework), [comunicado de prensa del Tribunal General](https://curia.europa.eu/site/upload/docs/application/pdf/2025-09/cp250106en.pdf)). En octubre de 2025 se interpuso un recurso de casación ante el Tribunal de Justicia que sigue pendiente de resolución, por lo que el marco se mantiene vigente en la actualidad, aunque una revisión prudente de proveedores debe tratarlo como un mecanismo a vigilar, no como un hecho consolidado. Para los proveedores que no cuentan con la certificación DPF, las Cláusulas Contractuales Tipo siguen siendo un mecanismo de transferencia lícito, como muestra el ejemplo de Anthropic más abajo.
...
4. [Sentencia del Tribunal General en Latombe c. Comisión (T-553/23)](https://curia.europa.eu/site/upload/docs/application/pdf/2025-09/cp250106en.pdf) — comunicado de prensa del TJUE, 3 de septiembre de 2025
5. [¿Qué es un subprocesador?](https://help.drata.com/en/articles/9792194-what-is-a-subprocessor) — Drata
6. [Visión general de la Gestión de Riesgos de Terceros](https://help.vanta.com/en/articles/11345557-third-party-risk-management-overview) — Vanta
7. Artículos 9, 28, 35, 45 y 46 del RGPD — Reglamento (UE) 2016/679
