...
metadata:
  title: 'IA Híbrida Sanitaria: Por Qué Importa'
  description: 'Por qué la IA híbrida y local es más segura que la nube para consultas sanitarias independientes. RGPD y sensibilidad de datos de pacientes.'
---
