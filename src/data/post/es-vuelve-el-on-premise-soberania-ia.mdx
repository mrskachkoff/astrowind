...
metadata:
  ...
  description: 'Comparativa de los bloques de modelos de IA estadounidense, chino y europeo en coste, control y jurisdicción. Por qué el on-premise y la infraestructura soberana vuelven a las decisiones de IA empresarial.'
  robots:
    index: true
    follow: true
  openGraph:
