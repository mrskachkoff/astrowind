...
metadata:
  title: 'GDPR Subprocessor Management Guide'
...
The DPF's legal footing was tested and, for now, confirmed: on 3 September 2025 the EU General Court dismissed the Latombe action (T-553/23) seeking to annul the adequacy decision, upholding both the independence of the U.S. Data Protection Review Court and the safeguards around intelligence collection ([IAPP](https://iapp.org/news/a/european-general-court-dismisses-latombe-challenge-upholds-eu-us-data-privacy-framework), [General Court press release](https://curia.europa.eu/site/upload/docs/application/pdf/2025-09/cp250106en.pdf)). An appeal to the Court of Justice was lodged in October 2025 and remains pending — so the framework stands today, but a prudent vendor review treats it as a mechanism to monitor, not a settled fact. For vendors that are not DPF-certified, Standard Contractual Clauses remain a lawful transfer mechanism, as the Anthropic example below shows.
...
4. [General Court judgment in Latombe v Commission (T-553/23)](https://curia.europa.eu/site/upload/docs/application/pdf/2025-09/cp250106en.pdf) — CJEU press release, 3 September 2025
5. [What Is a Subprocessor?](https://help.drata.com/en/articles/9792194-what-is-a-subprocessor) — Drata
6. [Third Party Risk Management Overview](https://help.vanta.com/en/articles/11345557-third-party-risk-management-overview) — Vanta
7. GDPR Articles 9, 28, 35, 45, and 46 — Regulation (EU) 2016/679
