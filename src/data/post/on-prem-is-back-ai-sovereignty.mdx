...
metadata:
  ...
  description: 'American, Chinese, and European AI model blocks compared on cost, control, and jurisdiction. Why on-premises and sovereign infrastructure are returning to enterprise AI decisions.'
  robots:
    index: true
    follow: true
  openGraph:
