...
tags:
  ...
  - subprocessor-risk
metadata:
  title: "OpenEvidence Exit: Private On-Prem AI"
  description: "Why OpenEvidence's EU/UK withdrawal points healthcare AI toward private on-premises and sovereign cloud architecture — GDPR, AI Act, and subprocessor analysis."
  robots:
    index: true
    follow: true
  openGraph:
...
<p className="text-center text-sm font-medium">On April 2026 in EU</p>
...
And if data is transferred outside the EU, GDPR Chapter V requires a valid transfer mechanism, such as DPF for certified U.S. companies or SCCs with appropriate safeguards. (The DPF itself survived the Latombe annulment action before the EU General Court in September 2025, though an appeal is pending at the Court of Justice — it stands today, but it is a mechanism to monitor.)

Now add the AI Act. If a medical AI system supports clinical workflows, diagnosis, treatment, or regulated medical-device functions, it may trigger high-risk obligations around documentation, oversight, monitoring, and risk management — applying from December 2027 for stand-alone Annex III systems and August 2028 for device-embedded AI, after the deferral in the June 2026 Digital Omnibus.
...
<p className="text-center text-sm font-medium">Possible Infrastructure</p>
