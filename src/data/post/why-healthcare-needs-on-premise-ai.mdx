...
tags:
  ...
  - private ai
metadata:
  title: 'Why Healthcare Needs On-Premise AI'
  description: 'Why on-premise AI is the only defensible approach for healthcare. Cloud contracts are not data sovereignty — the case for local AI infrastructure.'
---
...
The EU AI Act entered into force in August 2024, and its timeline was revised by the Digital Omnibus adopted in June 2026: obligations for stand-alone high-risk systems (Annex III) now apply from 2 December 2027, and for AI embedded in regulated medical devices (Annex I) from 2 August 2028. Not every healthcare AI system is high-risk — the classification covers specific uses such as clinical decision support and emergency triage, and most obligations fall on the system's provider rather than the clinic deploying it. Where a system is high-risk, the requirements include:
...
The deferral changes none of the GDPR picture: health-data obligations — Articles 9, 25 and 35 — apply in full today, whichever architecture you choose.
